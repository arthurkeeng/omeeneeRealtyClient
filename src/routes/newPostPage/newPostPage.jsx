...
function NewPostPage() {
  ...
  const handleSubmit = async (e) =>{
    ...
    try {
      const {data} = await app.post('/api/posts/create' , {
        postData : {
          type : inputs.type, 
      ...
      setError("post successfully added")
    } catch (error) {
  ...
  return (
    <div className="newPostPage">
      ...
      <div className="sideContainer">
          <p>A max display of 8 images appear here.
            
          </p>
          <p>However you have {images.length} selected</p>
